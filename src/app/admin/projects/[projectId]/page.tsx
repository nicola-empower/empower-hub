      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-gray-50 rounded-xl border">
          <div>
              ...
              <input type="date" value={formatDateForInput(project?.start_date)} onChange={(e) => handleProjectDateChange(e.target.value, 'start_date')} className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300" />
          </div>
          <div>
